...
<img src="https://render.githubusercontent.com/render/math?math=R"/>@<img src="https://render.githubusercontent.com/render/math?math=X=\frac{1}{Y}\sum_{y=1}^{Y}\frac{T_{y}^{X}}{G_{y}}." />
